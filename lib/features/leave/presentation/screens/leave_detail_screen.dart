...
class _LeaveDetailScreenState extends ConsumerState<LeaveDetailScreen>
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Divider(height: 24, color: theme.secondaryText.withValues(alpha: 0.2)),
                    _buildInfoRow(theme, l10n.leave.leaveId, '#${leave.id}', Icons.tag),
                    _buildInfoRow(
                      theme,
  ...
  Widget _buildInfoRow(FlutterFlowTheme theme, String label, String value, IconData icon) {
    return Padding(
